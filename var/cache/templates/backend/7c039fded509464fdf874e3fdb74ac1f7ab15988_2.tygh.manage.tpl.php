<?php
/* Smarty version 4.3.0, created on 2024-09-21 06:49:19
  from '/var/www/cscart/design/backend/templates/views/pages/manage.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_66eecedff18de3_51996784',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7c039fded509464fdf874e3fdb74ac1f7ab15988' => 
    array (
      0 => '/var/www/cscart/design/backend/templates/views/pages/manage.tpl',
      1 => 1723122726,
      2 => 'tygh',
    ),
  ),
...
function content_66eecedff18de3_51996784 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/cscart/app/functions/smarty_plugins/function.script.php','function'=>'smarty_function_script',),1=>array('file'=>'/var/www/cscart/app/functions/smarty_plugins/modifier.sizeof.php','function'=>'smarty_modifier_sizeof',),2=>array('file'=>'/var/www/cscart/app/functions/smarty_plugins/block.hook.php','function'=>'smarty_block_hook',),));
\Tygh\Languages\Helper::preloadLangVars(array('no_data','add_page','pages'));
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "pages_table", null, null);?>
    ...
    <input type="hidden" name="page_type" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['search']->value['page_type'], ENT_QUOTES, 'UTF-8');?>
" />
    <?php }?>
...
?>
                <?php $_smarty_tpl->_subTemplateRender("tygh:common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('tool_href'=>"pages.add?page_type=".((string)$_smarty_tpl->tpl_vars['_k']->value)."&come_from=".((string)$_smarty_tpl->tpl_vars['come_from']->value),'tool_override_meta'=>"btn btn-primary nav__actions-btn-primary",'prefix'=>"top",'title'=>$_smarty_tpl->__($_smarty_tpl->tpl_vars['_p']->value['add_name']),'link_text'=>$_smarty_tpl->__($_smarty_tpl->tpl_vars['_p']->value['add_name']),'hide_tools'=>true,'icon'=>"icon-plus"), 0, true);
?>
            <?php
}
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            <?php $_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
            <?php $_smarty_tpl->smarty->ext->_tplFunction->callTemplateFunction($_smarty_tpl, 'dropdown', array('content'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'tools_list'),'icon'=>"icon-plus",'text'=>$_smarty_tpl->__("add_page"),'class_toggle'=>"btn-primary nav__actions-btn-primary",'no_caret'=>true,'placement'=>"right"), true);?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
        ...
        <?php $_smarty_tpl->_subTemplateRender("tygh:buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('but_name'=>"dispatch[pages.m_update]",'but_role'=>"action",'but_target_form'=>"pages_tree_form",'but_meta'=>"cm-submit nav__actions-btn-save"), 0, false);
?>
    <?php }
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
</form>
