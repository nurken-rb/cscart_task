...
/* Smarty version 4.3.0, created on 2024-09-21 06:49:20
  from '/var/www/cscart/design/backend/templates/views/pages/components/pages_search_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_66eecee010b3d5_42374310',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c6a7b422908a39c4f217e34313efdefc9d363af1' => 
    array (
      0 => '/var/www/cscart/design/backend/templates/views/pages/components/pages_search_form.tpl',
      1 => 1723122726,
      2 => 'tygh',
    ),
  ),
...
function content_66eecee010b3d5_42374310 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/cscart/app/functions/smarty_plugins/function.array_to_fields.php','function'=>'smarty_function_array_to_fields',),1=>array('file'=>'/var/www/cscart/app/functions/smarty_plugins/modifier.sizeof.php','function'=>'smarty_modifier_sizeof',),2=>array('file'=>'/var/www/cscart/app/functions/smarty_plugins/modifier.truncate.php','function'=>'smarty_modifier_truncate',),3=>array('file'=>'/var/www/cscart/app/functions/smarty_plugins/block.hook.php','function'=>'smarty_block_hook',),));
...
" name="pages_search_form" method="get" class="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['form_meta']->value, ENT_QUOTES, 'UTF-8');?>
">
...
?>
        <option value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['t']->value, ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->tpl_vars['p']->do_else = false;
?>
    <input type="hidden" name="page_type" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['t']->value, ENT_QUOTES, 'UTF-8');?>
" />
    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
...
$_smarty_tpl->tpl_vars['p']->do_else = false;
?>
                <option value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['p']->value['page_id'], ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['parent_id'] == $_smarty_tpl->tpl_vars['p']->value['page_id']) {?>selected="selected"<?php }?>><?php echo preg_replace('!^!m',str_repeat("&#166;&nbsp;&nbsp;&nbsp;&nbsp;",$_smarty_tpl->tpl_vars['p']->value['level']),smarty_modifier_truncate(htmlspecialchars((string)$_smarty_tpl->tpl_vars['p']->value['page'], ENT_QUOTES, 'UTF-8', true),35,"...",true));?>
</option>
            <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
